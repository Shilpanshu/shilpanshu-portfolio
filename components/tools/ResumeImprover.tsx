    ...
    const handleScan = async () => {
        ...
        try {
            ...
            if (msg.includes("404") || msg.includes("not found")) {
                setError("API Key Error: This key cannot access 'gemini-1.5-flash'. Please create a NEW key at aistudio.google.com and ensure 'Generative Language API' is enabled.");
            } else {
